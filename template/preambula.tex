...
\titlespacing*{\section      }{0.0\parindent }{1.5\baselineskip}{0.8\baselineskip} % Раздел: без отступа слева
\titlespacing*{\subsection   }{1.0\parindent }{1.2\baselineskip}{0.8\baselineskip} % Подраздел: отступ слева равен абзацному отступу (\parindent)
\titlespacing*{\subsubsection}{2.0\parindent }{1.0\baselineskip}{0.8\baselineskip} % Подподраздел: отступ слева равен двум абзацным отступам
