...
\begin{equation}
    \begin{aligned}
        I_1(j\omega)
            ...
            &= -4\sin^2(\omega t_\text{и} / 4) \cdot \frac{I_m}{\omega} e^{-j(\omega t_\text{и}/4 + 90^\circ)} = \\
...
\begin{equation}
    A_1(\omega) = \left|
        -4\frac{I_m}{\omega} \sin^2\left(\frac{\omega t_{\text{и}}}{4}\right)
    \right|
\end{equation}
 
Фазовый спектр входного сигнала:
\begin{equation}
    \Phi_1(\omega) = -\frac{\omega t_\text{и}}{4} - 90^\circ
\end{equation}
