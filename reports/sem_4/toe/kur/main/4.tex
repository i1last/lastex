\directlua{dofile("code/4.lua")}

\section{Составление уравнений состояния цепи}

Для составления уравнений состояния выполним замену индуктивности источниками тока $i_{L1}$ и $i_{L2}$, а емкости --- источником напряжения $u_{C1}$.
...
На основе законов Кирхгофа для полученной резистивной схемы записываются соотношения, связывающие токи емкостей и напряжения на индуктивностях с переменными состояния и входным воздействием:
\begin{equation}
    \begin{cases}
...
\begin{equation}
    ...
    =
    \begin{bmatrix}
        \val[2]{mat.A11} & \val[2]{mat.A12} & \val[2]{mat.A13} \\
        \val[2]{mat.A21} & \val[2]{mat.A22} & \val[2]{mat.A23} \\
        \val[2]{mat.A31} & \val[2]{mat.A32} & \val[2]{mat.A33}
    \end{bmatrix}
    \cdot
    \begin{bmatrix}
        u_{C1} \\
