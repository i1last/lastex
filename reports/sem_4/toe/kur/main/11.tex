...
Расчёт реакции в общем виде осуществляется на основе спектра входного воздействия и АФХ цепи $H(j\omega)$ (см. \cref{form:Ainp,form:Phiinp} для спектров; \cref{form:AChH,form:FChH} для частотных характеристик): 
\begin{equation}
...
\begin{equation}
    \begin{aligned}
        ...
        \right)\right|_{\omega=k\omega_{1}} + \\
        &+ \left[
...
\begin{figure}[H]
    \centering
    \input{figs/plot_disc_spec_A_out_1.pgf}
...
\begin{figure}[H]
    \centering
    \input{figs/plot_disc_spec_Phi_out_1.pgf}
...
\begin{figure}[H]
    \centering
    \input{figs/plot_disc_spec_A_out_2.pgf}
...
\begin{figure}[H]
    \centering
    \input{figs/plot_disc_spec_Phi_out_2.pgf}
...
\begin{figure}[H]
    \centering
    \input{figs/plot_fourier_approx_out_1.pgf}
...
\begin{figure}[H]
    \centering
    \input{figs/plot_fourier_approx_out_2.pgf}
