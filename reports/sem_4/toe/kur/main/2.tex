...
Для нахождения операторной передаточной функции $H(s) = {I_{R2}(s)}/{I_1(s)}$ применяется метод пропорциональных величин. Цепь представляется операторной схемой замещения при нулевых начальных условиях.
