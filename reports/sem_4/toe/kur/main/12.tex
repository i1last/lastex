...
Из графиков видно, что, в отличие от ряда Фурье, решение в замкнутой форме описывает поведение цепи точно, отражая реальную физическую кривую установившегося процесса.