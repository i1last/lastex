...
Учитывая сигнал в виде меандра получаем итоговое выражние для $i_2(t)$:
\begin{equation}
    i_2(t) = i_{21}(t)\cdot\delta_1(t) - 2i_{21}(t - t_\text{и})\cdot\delta_1(t - t_\text{и}) + i_{21}(t - 2t_\text{и})\cdot\delta_1(t - 2t_\text{и})
\end{equation}
...
\begin{figure}[H]
    \centering
    \input{figs/plot_reaction_i1.pgf}
...
\begin{figure}[H]
    \centering
    \input{figs/plot_reaction_i2.pgf}
