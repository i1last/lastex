...
\begin{align}
    I_{2}(s) 
        ...
        &=  
            I_{21}(s) -
            I_{21}(s) \cdot 2e^{-s \frac14 T} +
            I_{21}(s) \cdot e^{-s \frac12 T},
\end{align}
...
\begin{equation}
    i_2(t)
        = 
            i_{21}(t)\delta_1(t) -
            i_{21}(t - \frac14 T)\cdot 2\delta_1(t - \frac14 T) +
            i_{21}(t - \frac12 T)\delta_1(t - \frac12 T),
    \label{form:i2torig}
\end{equation}
