...
\WorkTitle{ИССЛЕДОВАНИЕ ЭЛЕКТРИЧЕСКИХ СВОЙСТВ ПОЛУПРОВОДНИКОВЫХ МАТЕРИАЛОВ}
\Group{4494}
\Variant{---}
...
\noindent
\makeatletter
    \@StudentName; Фролов А. А., гр. \@Group ~~\hrulefill~~ «\rule{1cm}{0.4pt}» \rule{3cm}{0.4pt} 20\rule{0.75cm}{0.4pt} г.
\makeatother
\newpage
% --- ПРОТОКОЛ ---
