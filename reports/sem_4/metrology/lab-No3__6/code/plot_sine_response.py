...
p_data = lua.globals().protocol.sine_response
r_data = lua.globals().results.sine_response
...
ax2.plot(t, delta_y, '^-', color='red', label=r'$\Delta u(t)$')
