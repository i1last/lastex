...
\newcommand{\WorkType}{практической работе №2}    % По <\WorkType> (напр: По лабораторной работе №1)
\newcommand{\Discipline}{возобновляемая энергетика}  % По дисциплине <\Discipline>
\newcommand{\WorkTitle}{ИССЛЕДОВАНИЕ ВЛИЯНИЯ УГЛА НАКЛОНА ПАНЕЛИ НА ЭФФЕКТИВНОСТЬ ЕЕ РАБОТЫ}
